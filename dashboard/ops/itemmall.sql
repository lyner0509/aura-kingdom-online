...
CREATE TABLE IF NOT EXISTS dashboard.itemmall_history (
...
GRANT SELECT, INSERT ON dashboard.itemmall_history TO akdashboard;
GRANT USAGE, SELECT ON SEQUENCE dashboard.itemmall_history_id_seq TO akdashboard;
